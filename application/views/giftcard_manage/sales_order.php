        ...
        <div>
            <table id="card-info" cellspacing="0" cellpadding="0" border="0" style="margin: auto;">
                <thead>
                    ...
                    <tr>
                        <th>录入人:</th>
                        <th colspan="2" style="text-align: left;"><?php echo $order['modify_user']?></th>
                        <th>销售员:</th>
                        <th colspan="1" style="text-align: left;"><?php echo $order['user_name']?></th>
                        <th>销售日期:</th>
                        <th colspan="2" style="text-align: left;"><?php echo $order['trade_date']?></th>
                    </tr>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="8">最终客户：<?php echo $order['end_user']?></td>
                    </tr>
                    <tr>
                        <td colspan="2">联系人</td>
                    ...
                    <tr>
                        <td colspan="2"><?php echo $order['contact_person']?></td>
                        <td colspan="2"><?php echo $order['phone']?></td>
                        <td colspan="4"><?php echo $order['address']?></td>
                    </tr>
                    <tr>
