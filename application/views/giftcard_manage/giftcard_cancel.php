        ...
        <div class="form-horizontal" id="fileupload">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <label for="a_cancel_date" class="control-label col-sm-1">退卡日期</label>
                    <div class=" col-sm-2">
                        <input class="form-control" id="a_cancel_date" type="text" value="<?php echo date('Y-m-d');?>">
                    </div>
                ...
                <div class="form-group">
                    <label for="a_status" class="control-label col-sm-2">状态</label>
                    <div class="col-sm-2">
                        <select name="a_status" id="a_status" data-placeholder="选择状态" class="chzn_a form-control">
                            <option value="1" selected="selected">退卡不可重新销售</option>
                            <option value="2" selected="selected">退卡可重新销售</option>
                        </select>
                    </div>
                </div>
...
<script src="<?php echo RES; ?>giftcard/giftcard_cancel.js"></script>
