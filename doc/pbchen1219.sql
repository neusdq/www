...
insert  into `card_order`(`id`,`order_name`,`sales_id`,`custom_id`,`contact_person`,`delever_id`,`trade_date`,`expire_date`,`cancel_date`,`wechat_id`,`price`,`pay_status`,`pay_remark`,`end_user`,`remark`,`delivrer_num`,`status`,`modify_user`) values (5,'热热s*5',1,2,'',NULL,'2016-05-01','2016-05-01',NULL,2,'0.00',1,'test','yv','test777',NULL,4,NULL);
...
insert  into `user`(`id`,`user_name`,`nick_name`,`password`,`email`,`phone`,`role`,`create_time`) values (1,'pbchen','小城别顾','e10adc3949ba59abbe56e057f20f883e','294306275@qq.com','15201421880','1','2015-11-24 13:14:05'),(2,'test','test','d41d8cd98f00b204e9800998ecf8427e','test@qq.com','15201421670','1','2015-12-14 23:58:41'),(3,'test1','test1','d41d8cd98f00b204e9800998ecf8427e','test1@qq.com','15201421680','1','2015-12-15 00:00:35'),(5,'test111','test3','d41d8cd98f00b204e9800998ecf8427e','test3@qq.com','15201421680','2','2015-12-15 00:02:16');
