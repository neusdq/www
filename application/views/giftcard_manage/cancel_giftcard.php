...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <h3 class="heading">退还卡管理</h3>
        <div class="w-box-header">
            <div class="pull-left sort-disabled margin-left-2">
                <input name="s_name" class="input-medium form-control" placeholder="销售员" type="text">
            </div>
            <div class="pull-left sort-disabled margin-left-2">
                <input name="s_id" class="input-medium form-control" placeholder="时间" type="text">
            </div>
        ...
        <div class="w-box-header">
            <div class="pull-left sort-disabled">
                <a class="btn btn-success label" id="edit-pay-status">退卡</a>
            </div>
        </div>
